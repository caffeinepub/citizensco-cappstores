    ...
    <header className="sticky top-0 z-50 w-full border-b border-border/40 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="container flex h-16 items-center justify-between">
        <div className="flex items-center gap-3 cursor-pointer" onClick={() => navigate({ to: '/' })}>
          <img src="/assets/generated/logo.dim_200x200.png" alt="CitizensCo CAppStores" className="h-10 w-10" />
          <div>
            ...
            <p className="text-xs text-muted-foreground hidden sm:block">Decentralized DApp Marketplace</p>
          </div>
        </div>
        ...
        <nav className="hidden md:flex items-center gap-2">
          ...
          {isAuthenticated && (
            <>
              ...
              <Button variant="ghost" size="sm" onClick={() => navigate({ to: '/orders' })} className="gap-2">
              ...
              <Button variant="ghost" size="sm" onClick={() => navigate({ to: '/rewards' })} className="gap-2">
              ...
              <Button variant="ghost" size="sm" onClick={() => navigate({ to: '/dashboard' })} className="gap-2">
          ...
          <nav className="container flex flex-col gap-2 py-4">
            ...
            {isAuthenticated && (
              <>
                ...
                <Button variant="ghost" size="sm" onClick={() => { navigate({ to: '/orders' }); setMobileMenuOpen(false); }} className="justify-start gap-2">
                  <Package className="h-4 w-4" />
                  Orders
                </Button>
                ...
                <Button variant="ghost" size="sm" onClick={() => { navigate({ to: '/rewards' }); setMobileMenuOpen(false); }} className="justify-start gap-2">
                  <Gift className="h-4 w-4" />
                  Rewards
                </Button>
                <Button variant="ghost" size="sm" onClick={() => { navigate({ to: '/discovery' }); setMobileMenuOpen(false); }} className="justify-start gap-2">
                  <Compass className="h-4 w-4" />
                  Discovery
                </Button>
                <Button variant="ghost" size="sm" onClick={() => { navigate({ to: '/dashboard' }); setMobileMenuOpen(false); }} className="justify-start gap-2">
                  <BarChart3 className="h-4 w-4" />
                  Dashboard
                </Button>
              </>
            ...
            {isAdmin && (
              <Button variant="ghost" size="sm" onClick={() => { navigate({ to: '/admin' }); setMobileMenuOpen(false); }} className="justify-start gap-2">
                <Shield className="h-4 w-4" />
                Admin Panel
              </Button>
            )}
